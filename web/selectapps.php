...
<table border="0" cellpadding="20" align="center">
  <tr>
    <!--FIRST ROW -->
    <?php
    $query="select * from mobile_app_info";
...
function views(){
	$ggh = mysql_query("select * from vote A, mobile_app_info B where A.mob_id=B.mob_id ORDER By user_id DESC") or die (mysql_error());
	while($data=mysql_fetch_array($ggh)){
		echo '<img src="'.$data['mob_pic'].'" />';
	}
}
?>
</form>
